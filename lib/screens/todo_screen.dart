...
class _TodoScreenState extends State<TodoScreen> with TickerProviderStateMixin {
  ...
  Future<void> _loadData() async {
    ...
    // Initialize TabController after loading data
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        bottom: false, // ⬅️ امنع الـ SafeArea من الأسفل
        child: Padding(
          padding: const EdgeInsets.only(bottom: 85.0), // ⬅️ أضف padding إضافي
          child: TabBarView(
            controller: _tabController,
      ...
      child: Column(
        ...
        children: [
          ...
          ...section.items.asMap().entries.map((entry) {
            ...
            return _buildTodoItem(item, sectionIndex, itemIndex, page);
          }),
          const SizedBox(height: 8),
        ],
      ),
