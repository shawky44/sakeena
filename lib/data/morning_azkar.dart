...
List<Zikr> getMorningAzkar() {
  return [
    ...
    Zikr(
      id: 'm6',
      text:
          'اللّهُـمَّ أَنْتَ رَبِّـي لا إلهَ إلاّ أَنْتَ، خَلَقْتَنـي وَأَنا عَبْـدُك، وَأَنا عَلـى عَهْـدِكَ وَوَعْـدِكَ ما اسْتَـطَعْـت، أَعـوذُبِكَ مِنْ شَـرِّ ما صَنَـعْت، أَبـوءُ لَـكَ بِنِعْـمَتِـكَ عَلَـيَّ وَأَبـوءُ بِذَنْـبي فَاغْفـِرْ لي فَإِنَّـهُ لا يَغْـفِرُ الذُّنـوبَ إِلاّ أَنْتَ',
      count: 1,
      reference: 'من قالها موقنا بها حين يمسي ومات من ليلته دخل الجنة وكذلك حين يصبح',
    ),
    Zikr(
      id: 'm12',
      text:
      ...
      count: 3,
      reference:'من قالها حين يصبح وحين يمسي كان حقا على الله أن يرضيه يوم القيامة',
    ),
    Zikr(
      id: 'm8',
      text:
          'اللّهُـمَّ إِنِّـي أَصْبَـحْتُ أُشْـهِدُك، وَأُشْـهِدُ حَمَلَـةَ عَـرْشِـك، وَمَلَائِكَتَكَ، وَجَمـيعَ خَلْـقِك، أَنَّـكَ أَنْـتَ اللهُ لا إلـهَ إلاّ أَنْـتَ وَحْـدَكَ لا شَريكَ لَـك، وَأَنَّ ُ مُحَمّـداً عَبْـدُكَ وَرَسـولُـك',
      count: 4,
    ...
    Zikr(
      ...
      count: 10,
      reference: 'كانت له عدل عشر رقاب، وكتبت له مئة حسنة، ومحيت عنه مئة سيئة',
    ),
    ...
    Zikr(
      ...
      count: 100,
      reference: 'من قالها حطت خطاياه وإن كانت مثل زبد البحر',
    ),
  ];
}
